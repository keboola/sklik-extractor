...
class ExtractorTest extends AbstractTest
{
    ...
    public function testExtractionWithCorrectAccountId()
    {
        $this->createCampaign(uniqid());
        ...
        $e = new Extractor(EX_SK_USERNAME, EX_SK_PASSWORD, sys_get_temp_dir(), 'out.c-main', EX_SK_API_URL);
        $e->run($startDate, $endDate, false, EX_SK_USER_ID);
    ...
    public function testExtractionWithWrongAccountId()
    {
        $this->createCampaign(uniqid());
        ...
        $e = new Extractor(EX_SK_USERNAME, EX_SK_PASSWORD, sys_get_temp_dir(), 'out.c-main', EX_SK_API_URL);
        $e->run($startDate, $endDate, false, 333);
    }

    public function testExtractionWithShareImpressions()
    {
        $this->createCampaign(uniqid());
